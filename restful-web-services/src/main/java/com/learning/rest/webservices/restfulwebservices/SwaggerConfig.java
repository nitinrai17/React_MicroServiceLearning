...
public class SwaggerConfig {
		...
		public static final Contact DEFAULT_CONTACT = new Contact("Nitin Rai", "", "www.nitinrai.com");
		  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Test Api Documentation", " Test Api Documentation", "1.0", "urn:tos",
